...
"&clipboard", None))
        self.ResetTextPushButton.setText(_translate("Window", "R&eset", None))
        ...
        self.PositionsCheckBox.setText(_translate("Window", "Show po&sitions", None))
        ...
        self.ReplacementTextLabel.setText(_translate("Window", "Replace&ment text", None))
        ...
        self.SplitPushButton.setText(_translate("Window", "&Split text", None))
